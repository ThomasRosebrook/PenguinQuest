...
namespace Game3.Screens
{
    public class MainMenu : GameScreen
    {
        ...
        public override void HandleInput(GameTime gameTime, InputManager input)
        {
            ...
            if (input.JumpStart)
            {
                ScreenManager.AddScreen(new LevelSelectionScreen(), null);
                this.ExitScreen();
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            string currentText = "Penguin Quest";
            Vector2 size = _menuFont.MeasureString(currentText);
            spriteBatch.DrawString(_menuFont, currentText, new Vector2(width / 2 - size.X / 2, 20), Color.Orange);
            ...
            size = _gameFont.MeasureString(currentText);
            spriteBatch.DrawString(_gameFont, currentText, new Vector2(width / 2 - size.X / 2, height - size.Y), Color.White);;
